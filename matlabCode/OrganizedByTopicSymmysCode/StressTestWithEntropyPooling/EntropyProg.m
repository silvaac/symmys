...
options = optimset('GradObj','on','Hessian','on','MaxIter',10000,'TolFun',1e-8,'MaxFunEvals',10000,'HessFcn',@myHessian);
if ~K_
    ...
    function H = myHessian(lv,lambda) % NOT IN ORIGINAL CODE!!! NEED TO ADD TO MAKE OPT WORK (silva@dunncapital)
