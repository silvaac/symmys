function [ExpectedValue,Volatility, Composition] = EfficientFrontierQPRetsBench(NumPortf, Covariance, ExpectedValues, Benchmark)
...
for i=2:NumPortf-1
    ...
    bEq=[1
        TargetReturns(i)];
    Weights = quadprog(SecondDegree,FirstDegree,A,b,AEq,bEq,[],[],x0,options)';
