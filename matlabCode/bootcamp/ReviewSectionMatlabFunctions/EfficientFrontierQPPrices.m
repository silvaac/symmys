function [ExpectedValue,Std_Deviation, Composition] = EfficientFrontierQPPrices(NumPortf, Covariance, ExpectedValues,Current_Prices,Budget)
...
MinVol_Allocation = quadprog(SecondDegree,FirstDegree,A,b,Aeq,beq,[],[],x0,options);
