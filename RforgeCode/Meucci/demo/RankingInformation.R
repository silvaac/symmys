...
#'
#' This script performs ranking allocation using the Entropy-Pooling approach
#' by Attilio Meucci, as it appears in A. Meucci, "Fully Flexible Views: Theory
#' and Practice", The Risk Magazine, October 2008, p 100-106.
#'
...
#' "RankingInformation/S_MAIN.m"
#' 
#' @author  Xavier Valls \email{xaviervallspla@@gmail.com}

################################################################################
# Load panel X of joint returns realizations and vector p of respective
# probabilities
...
Options$NumPortf <- 20
# range of normalized exp.vals. spanned by efficient frontier
Options$FrontierSpan <- c(0.3, 0.9)
...
################################################################################
# process ordering information (the core of the Entropy Pooling approach)
################################################################################

# the expected return of each entry of Lower is supposed to be smaller than
# the respective entry in Upper
Lower <- 4  
Upper <- 3
